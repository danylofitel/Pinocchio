...
The downside of small number of features is that only fraction of available information is used. In practice we want feature vectors to include as many words as possible. Therefore, we should provide a different approximation.
